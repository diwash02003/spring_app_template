package com.template.configuration.jwt.service;
...
public class JwtService {
    ...
    public String generateToken(CustomUserDetails userDetails) {
        ...
        claims.put(TokenConstants.CLAIM_USER_ID, userDetails.getId());
        claims.put(TokenConstants.CLAIM_EMAIL, userDetails.getEmail());
    ...
    public List<String> extractAuthorities(String token) {
        Object roles = extractAllClaims(token).get(TokenConstants.CLAIM_AUTHORITIES);
    ...
    public boolean validateToken(String token, String username, List<String> roles) {
        try {
            ...
            if (roles != null && !roles.isEmpty()) {
                List<String> tokenRoles = extractAuthorities(token);
